...
T = TypeVar("T", bound="ScalewayQaasV1Alpha1PlatformPricePerCircuit")


@_attrs_define
class ScalewayQaasV1Alpha1PlatformPricePerCircuit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scaleway_qaas_v1_alpha_1_platform_price_per_circuit = cls(
            currency_code=currency_code,
            units=units,
            nanos=nanos,
        )

        scaleway_qaas_v1_alpha_1_platform_price_per_circuit.additional_properties = d
        return scaleway_qaas_v1_alpha_1_platform_price_per_circuit
